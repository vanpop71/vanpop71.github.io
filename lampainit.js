...
lampainit_invc.appload = function appload() {
  // Lampa.Utils.putScriptAsync(["https://popvan71.github.io/1/myplugin.js"]);  // wwwroot/myplugin.js
  // Lampa.Utils.putScriptAsync(["https://popvan71.github.io/1/ts-preload.js", "https://nb557.github.io/plugins/online_mod.js"]);
...
*/
  ...
  var timer = setInterval(function() {
    if (typeof Lampa !== 'undefined') {
      ...
      Lampa.Utils.putScriptAsync(["https://popvan71.github.io/1/cubproxy.js", "https://popvan71.github.io/1/privateinit.js?account_email=" + encodeURIComponent(Lampa.Storage.get('account_email', '')) + "&uid=" + encodeURIComponent(Lampa.Storage.get('lampac_unic_id', ''))], function() {});
  ...
  if (e.name == 'main') {
    e.body.find('[data-component="pirate_store"]').on('hover:enter', function() {
      Lampa.Extensions.show({
        store: 'https://popvan71.github.io/extensions',
        with_installed: true
      });
    });
  }
...
if (window.appready) addStore();
  ...
  function start() {
    ...
    Lampa.Storage.set('jackett_url', 'jac.maxvol.pro');
    Lampa.Storage.set('jackett_key', '1');
    Lampa.Storage.set('parser_torrent_type', 'jackett');

    var plugins = Lampa.Plugins.get();

    var plugins_add = [{"url": "https://popvan71.github.io/rus_movie.js","status": 1,"name": "rus_movie.js","author": "lampac"},{"url": "https://bwa.to/rc","status": 1,"name": "bwa.to","author": "lampac"},{"url": "https://popvan71.github.io/timecode.js","status": 1,"name": "timecode.js","author": "lampac"},{"url": "https://popvan71.github.io/lampa_rate.js","status": 1,"name": "lampa_rate.js","author": "lampac"},{"url": "https://popvan71.github.io/kinozal.js","status": 1,"name": "kinozal.js","author": "lampac"},{"url": "https://popvan71.github.io/t.js","status": 1,"name": "TMDB Proxy","author": "lampac"},{"url": "https://popvan71.github.io/mrm.js","status": 1,"name": "ratings","author": "lampac"},{"url": "https://popvan71.github.io/123.js","status": 1,"name": "123.js","author": "lampac"},{"url": "https://popvan71.github.io/torrents+.js","status": 1,"name": "torrents+.js","author": "lampac"},{"url": "https://popvan71.github.io/im.js","status": 1,"name": "im.js","author": "lampac"},{"url": "https://popvan71.github.io/pf.js","status": 1,"name": "pf.js","author": "lampac"},{"url": "https://popvan71.github.io/prisma_collections.js","status": 1,"name": "prisma_collections.js","author": "lampac"},{"url": "https://bywolf88.github.io/lampa-plugins/cinemabywolf.js","status": 1,"name": "cinema","author": "lampac"}];
